...
const SignUp = () => {
  ...
  return (
    <div className=" h-auto bg-zinc-900 px-10 py-8 flex items-center justify-center">
      <div className="bg-zinc-800 rounded-lg px-8 py-5 w-full md:w-3/6 lg:w-2/6">
        ...
        <div className="mt-4">
          ...
          <div className="mt-4">
            <button
              className="w-full bg-pink-500 text-white font-semibold py-2 rounded hover:bg-pink-600 transition-all duration-300"
              onClick={submit}
            >
              SignUp
            </button>
